  ...
  return (
    <>
      <div className={styles.navbar}>
        ...
        <a href="/student-dashboard"><Image src="/../public/icons/lightStudyIcon.png" width={350} height={350} /></a>
        <a href="student-dashboard"><Image src="/../public/icons/lightSubjectIcon.png" width={200} height={200} /></a>
        <a href="/"><FontAwesomeIcon icon={faArrowRightFromBracket} className="fa-4x  px-4" /></a>
      </div>
    </>
  );
};
